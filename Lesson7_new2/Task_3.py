...
class PublicTransport:
    ...
    # Следующий метод(свойство) выводит на печать информацию об автомобиле
    @property
    def info(self):
        print(
            f'Марка: {self.brand}\n'
...
class Bus(PublicTransport):
    ...
    # Следующие методы(свойство) возвращает значение парк и проверяет его значение от 1000 до 9999
    @property
    def park(self):
        return self.__park
...
class Tram(PublicTransport):
    ...
    # Следующий метод(свойство) высчитывает скорость прохождения маршрута по формуле
    @property
    def how_long(self):
