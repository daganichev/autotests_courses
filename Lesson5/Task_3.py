...
def everything_for_your_cat(cats_data):
    ...
    for i in cats_data:
        ...
        if people not in people_and_cats_dict:
            people_and_cats_dict[people] = ''
        people_and_cats_dict[people] += str(i[0]) + ', ' + str(i[1]) + '; '
    # Цикл для формирования строки на основании заполненного словаря
    for i in people_and_cats_dict:
        our_str += str(i) + ': ' + str(people_and_cats_dict[i])[:-2] + '\n'
    return our_str
