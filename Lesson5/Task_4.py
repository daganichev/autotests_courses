...
def scrabble(word):
    """
    В функции создаем словарь{буква: баллы}, при помощи цикла высчитываем балы во входящем слове и
    возвращает кол-во баллов
    :param word: получаем строку
    :return: возвращаем целое число
    """
    points = 0
    points_dict = {'а': 1, 'в': 1, 'ё': 1, 'е': 1, 'и': 1, 'н': 1, 'о': 1, 'р': 1, 'с': 1, 'т': 1,
